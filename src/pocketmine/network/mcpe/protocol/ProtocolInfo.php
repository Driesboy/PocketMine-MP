...
interface ProtocolInfo{
	...
	public const PROTOCOL_1_16_100 = 416;

	/** Actual Minecraft: PE protocol version */
	public const CURRENT_PROTOCOL = self::PROTOCOL_1_16_100;
	/** Array of all accepted protocol versions */
	public const ACCEPTED_PROTOCOLS = [self::CURRENT_PROTOCOL, self::PROTOCOL_1_16_20, self::PROTOCOL_1_16_0, self::PROTOCOL_1_14_60, self::PROTOCOL_1_14_0];
